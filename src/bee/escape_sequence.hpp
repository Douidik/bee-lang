#ifndef BEE_ESCAPE_SEQUENCE_HPP
#define BEE_ESCAPE_SEQUENCE_HPP
...
std::string escape_string(std::string_view s, s32 depth = 1);
std::string un_escape_string(std::string_view s, s32 depth = 1);
